...
static void main_window_load(Window *window) {
    ...
    s_text_layer = text_layer_create(GRect(0, 30, bounds.size.w, 30));
    text_layer_set_text(s_text_layer, "KeMo");
    ...
    s_time_layer = text_layer_create(GRect(0, 65, bounds.size.w, 55));
